# DRAFT - Creating and Hosting a Web Map with MapLibre and GitHub Pages
...
* [Sublime](https://www.sublimetext.com/) is very popular with Mac users, and has versions for Windows and Linux, as well. It's very simple, and a great first "code" editor.
* [Visual Studio Code](https://code.visualstudio.com/) for macOS or Windows is a widely used code editor with many integrations.
