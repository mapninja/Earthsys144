...
This week we move fully into **vector analysis**. The main shift is that spatial layers are no longer just things to display. They become inputs to workflows that reshape geography, combine criteria, estimate values across mismatched boundaries, and model movement through connected systems.
...
- [Week 04 - Basic Vector Analysis](https://mapninja.github.io/Earthsys144/week04/README.html)
